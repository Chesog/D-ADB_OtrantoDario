...
void InsertTableData(string tableName)
{
	...
	string descriptionCharacter;
	string historyCharacter;
	int IdSkill;
	int IdWeapon;
	...
	case (int)TableNames::USERS:
		...
		cout << "User ---> ";
		cin >> userPasword;
		comand = "insert into " + tableName + " (UserName,UserPasword) values ('" + userName + "'," + to_string(userPasword) + ")";
		break;
	case (int)TableNames::WEAPONS:
		cout << "Ingrese el Nombre" << endl;
		cout << "User ---> ";
		cin >> userName;
		comand = "insert into " + tableName + " (nameWeapon) values (" + userName + ")";
		break;
	case (int)TableNames::SKILLS:
		cout << "Ingrese el Nombre" << endl;
		cout << "User ---> ";
		cin >> userName;
		comand = "insert into " + tableName + " (nameSkill) values (" + userName + ")";
		break;
	case (int)TableNames::CHARACTERS:
		cout << "Ingrese el Nombre" << endl;
		cout << "User ---> ";
		...
		cout << "User ---> ";
		cin >> descriptionCharacter;
		cout << "Ingrese la Historia" << endl;
		cout << "User ---> ";
		cin >> descriptionCharacter;
		cout << "Ingrese la ID de la Skill" << endl;
		cout << "User ---> ";
		cin >> IdSkill;
		cout << "Ingrese la ID del arma" << endl;
		cout << "User ---> ";
		cin >> IdWeapon;
		comand = "insert into " + tableName + " (nameCharacter, descriptionCharacter, historyCharacter, IdSkill, IdWeapon) values ('" + userName + "'," + descriptionCharacter + descriptionCharacter+ to_string(IdSkill) + to_string(IdWeapon) + ")";
		break;
	case (int)TableNames::PLAYERS:
		throw ERROR_CALL_NOT_IMPLEMENTED;
		break;
...
void UpdateTableData(string tableName)
{
	...
	{
	case (int)TableNames::USERS:
		comand = "update " + tableName + " set " + columToChange + " = '" + valueToChange + "' where UserId = " + to_string(columId);
		break;
	case (int)TableNames::WEAPONS:
		comand = "update " + tableName + " set " + columToChange + " = '" + valueToChange + "' where IdWeapon = " + to_string(columId);
		break;
	case (int)TableNames::SKILLS:
		comand = "update " + tableName + " set " + columToChange + " = '" + valueToChange + "' where IdSkill = " + to_string(columId);
		break;
	case (int)TableNames::CHARACTERS:
		comand = "update " + tableName + " set " + columToChange + " = '" + valueToChange + "' where IdCharacter = " + to_string(columId);
		break;
	case (int)TableNames::PLAYERS:
		comand = "update " + tableName + " set " + columToChange + " = '" + valueToChange + "' where IdPlayer = " + to_string(columId);
		break;
	}
...
void DeleteTableData(string tableName)
{
	...
	{
	case (int)TableNames::USERS:
		comand = "delete from " + tableName + " where UserId = " + to_string(columId);
		break;
	case (int)TableNames::WEAPONS:
		comand = "delete from " + tableName + " where IdWeapon = " + to_string(columId);
		break;
	case (int)TableNames::SKILLS:
		comand = "delete from " + tableName + " where IdSkill = " + to_string(columId);
		break;
	case (int)TableNames::CHARACTERS:
		comand = "delete from " + tableName + " where IdCharacter = " + to_string(columId);
		break;
	case (int)TableNames::PLAYERS:
		comand = "delete from " + tableName + " where IdPlayer = " + to_string(columId);
		break;
	}
	query = comand.c_str();
	status = mysql_query(conectionStatus, query);
